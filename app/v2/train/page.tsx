        ...
        <div className="fixed inset-0 z-[55] flex items-end" onClick={() => setShowChooser(false)}>
          ...
          <div className="relative w-full rounded-t-[24px] border-t border-[var(--rd-border)] p-5 pb-8" style={{ background: '#0F1117' }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="mt-4 space-y-2.5">
              ...
              <button onClick={() => { setShowChooser(false); setShowText(true); }} className="flex w-full items-center gap-3 rounded-[14px] border border-[var(--rd-border)] bg-[var(--rd-card)] p-4 text-left">
                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[11px] text-white" style={{ background: 'linear-gradient(135deg,#F58529,#DD2A7B,#8134AF)' }}>
                ...
                <span className="min-w-0">
                  <span className="block text-[15px] font-semibold text-[var(--rd-ink)]">Paste a workout</span>
