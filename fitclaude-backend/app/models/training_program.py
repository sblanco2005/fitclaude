...
class TrainingProgram(Base):
    ...
    split_type: Mapped[str] = mapped_column("splitType", String)
    rotation: Mapped[str] = mapped_column(Text)  # JSON array
    current_day_index: Mapped[int] = mapped_column("currentDayIndex", default=0)
...
class ProgramDay(Base):
    ...
    day_index: Mapped[int] = mapped_column("dayIndex")
    exercise_template: Mapped[str] = mapped_column("exerciseTemplate", Text)  # JSON
