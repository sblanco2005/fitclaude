...
async def get_user_workouts(
    ...
    query = (
        ...
        .where(
            ...
            Workout.date >= datetime.utcnow() - timedelta(days=days_back),
        )
...
async def get_workout_by_id(db: AsyncSession, workout_id: str) -> Workout | None:
...
async def get_average_fatigue(
    db: AsyncSession, user_id: str, last_n: int = 3
) -> float | None:
